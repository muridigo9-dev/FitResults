-- Add landing_page_theme to brand_settings
ALTER TABLE public.brand_settings ADD COLUMN IF NOT EXISTS landing_page_theme TEXT DEFAULT 'light' CHECK (landing_page_theme IN ('light', 'dark'));

-- Update get_user_branding to include landing_page_theme
