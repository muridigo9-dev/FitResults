-- =========================================================
-- FIX: Re-apply export_workouts function to solve Window Function error
-- This migration forces the update of the RPC function
-- =========================================================
...
BEGIN
    ...
    -- This CTE isolates the window function from the aggregation step
    blocks_ordered AS (
        SELECT 
            workout_id,
            block_type,
